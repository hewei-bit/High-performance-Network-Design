...
BIN = nty_server nty_client nty_bench nty_server_mulcore nty_http_server nty_mysql_client nty_mysql_oper nty_websocket_server nty_http_server_mulcore ntyco_httpd
